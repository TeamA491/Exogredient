...
namespace TeamA.Exogredient.Tests
{
    ...
    public class UserManagementServiceTests
    {
                                                                                          ...
                                                                                          string phoneNumber, string password, int isDisabled, string userType, string salt)
        {
            ...
            bool result = await _userManagementService.CheckUserExistenceAsync(username).ConfigureAwait(false);
                                                                                                             ...
                                                                                                             string phoneNumber, string password, int isDisabled, string userType, string salt)
        {
            ...
            bool result = await _userManagementService.CheckPhoneNumberExistenceAsync(phoneNumber).ConfigureAwait(false);
            Assert.IsTrue(result);
                                                                                            ...
                                                                                            string phoneNumber, string password, int isDisabled, string userType, string salt)
        {
            ...
            bool result = await _userManagementService.CheckEmailExistenceAsync(email).ConfigureAwait(false);
            Assert.IsTrue(result);
                                                                                               ...
                                                                                               string phoneNumber, string password, int isDisabled, string userType, string salt)
        {
            ...
            bool result = await _userManagementService.CheckIfUserDisabledAsync(username).ConfigureAwait(false);
            Assert.IsTrue(result);
        ...
        public async Task UserManagementService_CheckIfIPLockedAsync_IpIsDisabledSuccess(string ipAddress)
        {
            ...
            bool lockResult = await _userManagementService.CreateIPAsync(ipAddress).ConfigureAwait(false);
            ...
            for (int i = 0; i < 3; i++)
            {
                bool registerResult = await _userManagementService.IncrementRegistrationFailuresAsync(ipAddress, Constants.RegistrationTriesResetTime, Constants.MaxRegistrationAttempts).ConfigureAwait(false);
                Assert.IsTrue(registerResult);
            }


            // Act
            bool result = await _userManagementService.CheckIfIPLockedAsync(ipAddress).ConfigureAwait(false);

            // Assert: Check that an IP that is inserted returns true.
            Assert.IsTrue(result);

            // Cleanup: Delete the IP.
            bool deleteResult = await _userManagementService.DeleteIPAsync(ipAddress).ConfigureAwait(false);
            Assert.IsTrue(deleteResult);
        ...
        public async Task UserManagementService_CheckIPLockAsync_IpIsNotDisabledSuccess(string ipAddress)
        {
            ...
            try
            {
                await _userManagementService.CheckIfIPLockedAsync(ipAddress).ConfigureAwait(false);
                result = false;
            }
            catch
            {
                                                                                  ...
                                                                                  string phoneNumber, string password, int disabled, string userType, string salt)
        {
            ...
            // Act: Delete the user 
            bool result = await _userManagementService.DeleteUserAsync(username).ConfigureAwait(false);
            Assert.IsTrue(result);

            // Assert: that the user is properly deleted from the table with CheckUserExistence
            bool existResult = await _userManagementService.CheckUserExistenceAsync(username).ConfigureAwait(false);
                                                                                     ...
                                                                                     string phoneNumber, string password, int disabled, string userType, string salt)
        {
            ...
            bool createResult = await _userManagementService.CreateUserAsync(isTemp, user).ConfigureAwait(false); Assert.IsTrue(createResult);

            // Act: Make the temporary user perm
            bool result = await _userManagementService.MakeTempPermAsync(username).ConfigureAwait(false);
            Assert.IsTrue(result);
                                                                                            ...
                                                                                            string phoneNumber, string password, int disabled, string userType, string salt, string emailCode, long emailCodeTimestamp)
        {
            ...
            bool result = await _userManagementService.StoreEmailCodeAsync(username, emailCode, emailCodeTimestamp).ConfigureAwait(false);
            Assert.IsTrue(result);
                                         ...
                                         string phoneNumber, string password, int disabled, string userType, string salt, string emailCode, long emailCodeTimestamp)
        {
            ...
            bool storeResult = await _userManagementService.StoreEmailCodeAsync(username, emailCode, emailCodeTimestamp).ConfigureAwait(false);
            Assert.IsTrue(storeResult);

            // Act: Remove the email code for that user.
            bool result = await _userManagementService.RemoveEmailCodeAsync(username).ConfigureAwait(false);
            Assert.IsTrue(result);
                                         ...
                                         string phoneNumber, string password, int disabled, string userType, string salt)
        {
            ...
            bool result = await _userManagementService.DisableUserAsync(username).ConfigureAwait(false);
            Assert.IsTrue(result);
        ...
        public async Task UserManagementService_DisableUserNameAsync_DisableNonExistingUserFailure(string username)
        {
            ...
            try
            {
                await _userManagementService.DisableUserAsync(username).ConfigureAwait(false);
                result = false;
            }
            catch
            {
                                         ...
                                         string phoneNumber, string password, int disabled, string userType, string salt)
        {
            ...
            bool enableResult = await _userManagementService.EnableUserAsync(username).ConfigureAwait(false);
                                         ...
                                         string phoneNumber, string password, int disabled, string userType, string salt)
        {
            ...
            bool result = await _userManagementService.EnableUserAsync(username).ConfigureAwait(false);
            Assert.IsFalse(result);
                                                                                     ...
                                                                                     string phoneNumber, string password, int disabled, string userType, string salt)
        {
            ...
            bool updateResult = await _userManagementService.UpdateUserAsync(userUpdate).ConfigureAwait(false);
