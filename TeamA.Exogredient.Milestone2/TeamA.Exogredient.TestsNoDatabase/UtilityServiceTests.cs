...
namespace TeamA.Exogredient.TestsNoDatabase
{
    ...
    public class UtilityServiceTests
    {
        ...
        [DataRow("password1")]
        [DataRow("abc123")]
        public void StringUtilityService_IsCorruptedPassword_IsCorruptedAsyncSuccess(string plaintextPassword)
        {
            // Act
            bool result = UtilityService.IsCorruptedPassword(plaintextPassword);
