...
export const ApiDomainName = "https://localhost:44357";
...
export const DescriptionResponseKey = "description";
export const ImageResponseKey = "image";
export const IngredientNameResponseKey = "ingredientName";
export const PriceResponseKey = "price";
export const PriceUnitResponseKey = "priceUnit";
export const RatingResponseKey = "rating";
export const ImageNameResponseKey = "imageName";
